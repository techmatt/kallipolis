...
\NEW{Sign}{\sLabSupplies}{
 ...
 \s\MYitems	{ \multi{4}{\iRestorativeTonic{}}
						  \multi{4}{\iPowerfulOuzo{}}
							\multi{4}{\iIntenseOuzo{}}
...
\NEW{Sign}{\sMedeaSupplies}{
 ...
 \s\MYitems	{ \multi{2}{\iFalseAlcohol{}} \multi{2}{\iFalseOpium{}} \multi{3}{\iRuinedIntoxicant{}} \multi{2}{\iAddictionSuppressor{}} }
  }
